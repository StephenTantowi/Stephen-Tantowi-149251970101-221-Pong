...
public class PowerUpManager : MonoBehaviour
{
    ...
    public void GenerateRandomPowerUp(Vector2 position)
    {
        ...
        GameObject powerUp = Instantiate(powerUpTemplateList[randomIndex], new Vector3(position.x,position.y,powerUpTemplateList[randomIndex].transform.position.z), Quaternion.identity,spawn);
